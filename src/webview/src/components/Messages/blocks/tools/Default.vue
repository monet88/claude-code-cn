...
const input = computed(() => {
  // Prioritize using toolUseResult (session load)
...
// Permission request stage default expansion, do not expand after execution
const shouldExpand = computed(() => {
  // Permission request stage expansion
