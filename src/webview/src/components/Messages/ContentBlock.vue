<template>
  <!-- Only pass wrapper to tool_use blocks to access toolResult Signal -->
  <component
    ...
    :context="context"
  />
  <!-- Other types do not need wrapper, avoid rendering to DOM -->
  <component
    v-else
    :is="blockComponent"
    :block="block"
...
// Select the corresponding component based on block.type
